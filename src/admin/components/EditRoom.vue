...
import DataService from '../../services/dataservice';
  ...
  export default {
    ...
    methods: {
      async fetchRooms() {
        try {
          const response = await DataService.fetchRooms();
      ...
      async addRoom() {
        try {
          const newRoom = await DataService.addRoom(this.currentRoom);
      ...
      async saveRoom() {
        if (this.roomToEdit) {
          try {
            const updatedRoom = await DataService.updateRoom(this.currentRoom.id, this.currentRoom);
